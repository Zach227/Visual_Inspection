...
def vis_conf_mat(conf_mat, cat_names, acc):
    ...
    # plt.show()
    _filename = 'test_confusion_mat.png'
    plt.savefig(_filename, bbox_inches='tight')


vec_test, cat_test = load_data('test_images')        # Get features for test data

le = preprocessing.LabelEncoder()
le.fit(cat_test)

# vec_test, cat_test = load_data('test_images')              # load test data
...
prediction = loaded_clf.predict(vec_test)          # make prediction on the test data
